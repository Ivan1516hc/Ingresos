                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('communities.destroy',$community->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('communities.show',$community->id) }}"><i class="la la-fw la-eye icon-button"></i> Show</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('communities.edit',$community->id) }}"><i class="la la-fw la-edit icon-button"></i> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
